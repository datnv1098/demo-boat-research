...
const translations: Translations = {
  ...
  'nav.adminCpue': { th: 'CPUE เขตทะเลตามจังหวัด', en: 'Marine ADM1 CPUE' },
  ...
  'adm.title': { th: 'CPUE เขตทะเลตามจังหวัด (ADM1)', en: 'Marine ADM1 CPUE Choropleth' },
  'adm.desc': { th: 'แผนที่เชิงพื้นที่ของ CPUE ถ่วงน้ำหนักตามพื้นที่ทะเลเชิงวิเคราะห์ที่อนุพันธ์จากจังหวัดชายฝั่ง', en: 'Weighted CPUE choropleth over derived marine polygons built from coastal ADM1 provinces' },
  'adm.notice': { th: 'ชุด polygon นี้เป็นขอบเขตทะเลเชิงวิเคราะห์สำหรับงาน choropleth v1 ไม่ใช่ขอบเขตทางกฎหมายในทะเล', en: 'These marine polygons are derived analytical regions for the v1 choropleth and are not legal maritime boundaries.' },
  'adm.metric': { th: 'ตัวชี้วัด', en: 'Metric' },
  'adm.metric.catch': { th: 'สัตว์น้ำจับได้', en: 'Catch' },
  'adm.metric.effort': { th: 'ความพยายาม', en: 'Effort' },
  'adm.metric.hauls': { th: 'จำนวน haul', en: 'Hauls' },
  'adm.level.adm1': { th: 'ADM1 จังหวัดชายฝั่ง', en: 'ADM1 coastal provinces' },
  'adm.showHauls': { th: 'แสดงจุด haul', en: 'Show haul points' },
  'adm.kpi.weightedCpue': { th: 'CPUE ถ่วงน้ำหนัก', en: 'Weighted CPUE' },
  'adm.kpi.regionsWithData': { th: 'พื้นที่ที่มีข้อมูล', en: 'Regions with data' },
  'adm.kpi.assignedHauls': { th: 'haul ที่ map ได้', en: 'Assigned hauls' },
  'adm.kpi.assignmentCoverage': { th: 'ความครอบคลุมของการจัดสรรพื้นที่', en: 'Spatial assignment coverage' },
  'adm.kpi.topRegion': { th: 'พื้นที่สูงสุด', en: 'Top region' },
  'adm.table.title': { th: 'อันดับพื้นที่ตามตัวชี้วัด', en: 'Region ranking by metric' },
  'adm.table.region': { th: 'พื้นที่', en: 'Region' },
